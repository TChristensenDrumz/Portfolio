...
function Contact() {
    function sendEmail(e) {
        ...
        emailjs.sendForm('service_gs3wumj', 'template_pf1wjpf', e.target, 'user_6wej1p0kkFuF1IK4NKKIg')
          .then((result) => {
                    ...
                    <div className="row mt-5">
                        <div className="col-sm-9 col-xs-12">
                            ...
                            <form className="contact-form" onSubmit={sendEmail}>
                                ...
                                <div className="form-group mr-5">
                                    <label>Message</label>
                                    <textarea className="form-control" id="contact-message" name="message" placeholder="Message"/>
                                </div>
